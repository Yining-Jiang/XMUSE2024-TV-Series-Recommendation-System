...
def get_teleplay_links(nums=1000):
...
if __name__ == '__main__':
    #url = 'https://teleplay.douban.com/tv/#!type=tv&tag=%E7%83%AD%E9%97%A8&sort=recommend&page_limit=20&page_start=0'
    url = 'https://movie.douban.com/tv/'
    option = webdriver.ChromeOptions()
    browser = webdriver.Chrome(executable_path='C:/Users/Icety/AppData/Local/Google/Chrome/Application/chromedriver.exe', options=option)
    get_teleplay_links(2000)
    browser.close()
